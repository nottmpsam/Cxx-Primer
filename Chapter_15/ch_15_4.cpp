...
int main()
{
   ...
   catch(Sales::bad_index &e)
   {
       ...
       if (typeid(e) == typeid(LabeledSales::nbad_index)) {
           LabeledSales::nbad_index nbad = dynamic_cast<LabeledSales::nbad_index&>(e);
   ...
   catch (std::logic_error &e) 
   {
       e.what();
       if (typeid(e) == typeid(LabeledSales::nbad_index&)) {
            LabeledSales::nbad_index bad = dynamic_cast<LabeledSales::nbad_index &> (e);
            cout << "Company: " << bad.label_val() << endl;
            cout << "bad index: " << bad.bi_val() << endl;
        } else {
            Sales::bad_index bad = dynamic_cast<Sales::bad_index &> (e);
            cout << "bad index: " << bad.bi_val() << endl;
        }
